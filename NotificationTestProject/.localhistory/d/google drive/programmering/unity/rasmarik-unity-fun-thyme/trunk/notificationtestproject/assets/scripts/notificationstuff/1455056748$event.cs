...
public class Event : Singleton<Event>
{
    ...
    #region Specific events, posted to and listened to in the  Defined here for easy and decoupled access.
    public EventInt AnyKeyPressed = new EventInt();
    public EventInt AnyKeyPressed2 = new EventInt();
    public EventInt AnyKeyPressed3 = new EventInt();
    public EventInt AnyKeyPressed4 = new EventInt();
    public int aer = 5;
    #endregion
