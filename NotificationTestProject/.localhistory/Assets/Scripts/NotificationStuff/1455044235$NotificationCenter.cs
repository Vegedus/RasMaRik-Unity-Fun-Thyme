...
/// </summary>
using Handler = System.Action<Object object, Object object>;
...
/// </summary>
using SenderTable = System.Collections.Generic.Dictionary<System.Object, System.Collections.Generic.List<System>>;
...
public class NotificationCenter : ScriptableObject
{
    ...
    #region Public
    public static void AddObserver(Handler handler, string notificationName)
    {
        AddObserver(handler, notificationName, null);
    }

    public static void AddObserver(Handler handler, string notificationName, System.Object sender) where MethodType : class
    {
        if (handler == null)
        {
