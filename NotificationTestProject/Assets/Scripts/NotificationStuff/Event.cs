...
public class Event : Singleton<Event>
{
    ...
    #region Utility functions, for easing access to events under certain circumstances
    //Useful for invoking directly from other unityEvents. Hardcoded strings 
    ...
    //Used for invoking directly from other unityEvents, UI toggles especially. Hardcoded strings & reflection 
    ...
    #region Extensions to UnityEvents, enabling invoking the method with parameters
    [Serializable]
